$(document).ready( function () {
    //set animation control variable to default values
    ...
    //99 bubbles seems like a good number
    var numBubbles = 99;
    //initialise array
    var bubbleArray = new Array(numBubbles);
    //set constraints on random values
    var maxRadius = 10;
    var minRadius = 2;
    var maxSpeed = 6;
    var minSpeed = 2;
    ...
    function blackTheme() {
        ...
        //set background to black and other css values
    ...
    function whiteTheme() {
        ...
        //hide bubbles
        $("#bubbleEffect").css("opacity", "0");
        //set background to white and other css values
        $("body").css("background-image", "url()");
    ...
    //enable animations ONLY IF DISABLED
    ...
    //create 99 random bubbles and put them into an array
    ...
    //move the bubbles one tick's worth
    function move() {
